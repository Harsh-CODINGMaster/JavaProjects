...
class Update_Employee extends Add_Employee implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == b && i == 1) {
			try {
				conn con = new conn();
				String str = "update employee set name='" + t1.getText() + "',Fname='" + t2.getText() + "',Age='" + age
						+ "',DOB='" + dat + "',Address='" + t3.getText() + "',phoneNO='" + t4.getText() + "',EmailID='"
						+ t5.getText() + "',Education='" + t6.getText() + "',JobPost='" + t7.getText() + "',AdhaarNO='"
						+ t8.getText() + "',EmpID='" + t9.getText() + "' where EmpID='" + id_emp + "'";
